...
abstract class iHRIS_PageCalendar extends I2CE_Page {
    ...
    protected function action() {
        ...
        $this->template->setDisplayDataImmediate( 'calendar_current', 'month=' . $this->now['mon']. '&year=' . $this->now['year'] . ( $this->list_view ? "&list_view=1" : "" ) );
        ...
        $this->template->setDisplayDataImmediate( 'calendar_list_view',
                'month=' . $this->month .'&year=' . $this->year . '&list_view=1' );
        ...
        $this->template->setDisplayDataImmediate( 'calendar_previous_month', 'month=' . $prev_mon. '&year=' . $prev_year . ($this->list_view ? "&list_view=1" : "" ) );
        ...
        $this->template->setDisplayDataImmediate( 'calendar_next_month', 'month=' . $next_mon. '&year=' . $next_year . ( $this->list_view ? "&list_view=1" : "" ) );
        $this->template->setDisplayDataImmediate( 'calendar_previous_year', 'month=' . $this->month . '&year=' . ($this->year-1) . ($this->list_view ? "&list_view=1" : "" ) );
        $this->template->setDisplayDataImmediate( 'calendar_next_year', 'month=' . $this->month . '&year=' . ($this->year+1) . ($this->list_view ? "&list_view=1" : "" )  );
        if ( $this->list_view ) {
